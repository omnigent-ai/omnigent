    ...
    <PageScroll contentClassName="px-6">
      ...
      {failedSessionCount > 0 && (
        <div
          ...
          className="mb-4 flex items-center gap-2 rounded-lg border border-destructive/30 bg-destructive/5 px-3 py-2 text-sm [box-shadow:var(--elevation-otto-1)]"
        >
        ...
        {items.map((item, index) => {
          ...
          return (
            <div
              ...
              className="flex flex-col gap-2 rounded-xl border border-[var(--border-otto-container)] bg-card p-4 [box-shadow:var(--elevation-otto-1)]"
            >
        ...
        {commentInbox.items.map((item) => {
          ...
          return (
            <div
              ...
              className="flex gap-3 rounded-xl border border-[var(--border-otto-container)] bg-card p-4 [box-shadow:var(--elevation-otto-1)]"
            >
