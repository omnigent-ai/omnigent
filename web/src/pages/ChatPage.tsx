...
export function ChatPage() {
  ...
  // OR'd with the first-message delivery flag: while that is retrying, the
  // runner is by definition not online yet, which is exactly the case
  // `computeShowsWorking` suppresses — so a session waiting on its own
  // first message would otherwise read as idle with an empty transcript.
  const showsWorking =
