        ...
        <div className="flex flex-col gap-3">
          {policies.map((p) => {
            ...
            return (
              <div
                key={p.id ?? p.name}
                className="rounded-lg border border-[var(--border-otto-container)] bg-background p-4 [box-shadow:var(--elevation-otto-1)]"
              >
                ...
                {hasParams && (
                  <div className="ml-6.5 mt-2 rounded-md border border-[var(--border-otto-hairline)] bg-muted/40 px-3 py-2 [box-shadow:var(--elevation-otto-1)]">
