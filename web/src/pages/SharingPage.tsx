    ...
    <PageScroll contentClassName="px-8" extraBottom="2.5rem">
      <div>
        ...
        {isLoading || current === undefined ? (
          ...
          <>
            {!editable && (
              <p className="mb-4 rounded-md border border-[var(--border-otto-container)] bg-muted/40 px-3 py-2 text-sm text-muted-foreground [box-shadow:var(--elevation-otto-1)]">
            ...
            <div className="mt-6 flex items-center justify-between rounded-lg border border-[var(--border-otto-container)] px-4 py-3 [box-shadow:var(--elevation-otto-1)]">
              <div className="pr-4">
