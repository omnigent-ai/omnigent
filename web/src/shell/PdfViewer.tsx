      ...
      {floating &&
        ...
        createPortal(
          <button
            ...
            type="button"
            className="fixed z-50 flex items-center gap-1.5 rounded-sm border border-border bg-popover backdrop-blur-xl backdrop-saturate-150 px-2.5 py-1 text-xs font-medium text-foreground shadow-md hover:bg-secondary transition-colors"
