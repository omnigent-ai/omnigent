          ...
          <TabsList variant="pill" className="gap-1">
            {showFilesPanel && (
              <TabsTrigger
                ...
                title="Files"
                className="size-8 shrink-0 rounded-[var(--radius-otto-button)] p-0"
              >
            ...
            {showShellsTab && (
              ...
              >
                ...
                {terminalsLength > 0 && (
                  <span className={cn(TAB_BADGE_BASE, "sr-only text-muted-foreground")}>
                    {terminalsLength}
                  </span>
                )}
              </TabsTrigger>
            ...
            <TabsTrigger
              ...
              className="size-8 shrink-0 rounded-[var(--radius-otto-button)] p-0 disabled:opacity-55"
            >
