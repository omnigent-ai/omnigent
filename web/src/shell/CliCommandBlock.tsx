...
export function CliCommandBlock({
  ...
  return (
    ...
    <div className="flex w-full items-center gap-2 rounded-[var(--radius-otto-sm)] border border-[var(--border-otto-container)] bg-muted px-3 py-2 font-mono text-xs [box-shadow:var(--elevation-otto-1)]">
      <code
