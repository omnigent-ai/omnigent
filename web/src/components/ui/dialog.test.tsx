...
describe("DialogContent viewport safety", () => {
  ...
  it("renders no scroller when the only middle child is currently off", () => {
    ...
    // An all-null middle would otherwise render an empty scroller, adding a
    // stray `gap-4` between header and footer.
