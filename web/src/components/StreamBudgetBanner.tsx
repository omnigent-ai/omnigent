 ...
 *
 * Renders as a rounded amber card; the caller floats it just below the chat
 * header (see the notice column in Transcript, a sibling inside the `relative`
 * conversation container). Dismissable per over-budget episode — a fresh
 * episode re-shows it (see `streamBudgetBannerDismissed`).
 */
