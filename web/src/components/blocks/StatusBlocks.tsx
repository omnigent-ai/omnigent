  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 text-xs">
        ...
        <span className="ml-auto shrink-0 inline-flex items-center whitespace-nowrap rounded-full border border-border bg-muted px-1.5 py-0.5 font-mono text-3xs font-medium leading-none text-foreground">
          {short}
        </span>
      </div>
      {rationale.length > 0 && (
