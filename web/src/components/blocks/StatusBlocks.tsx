...
const FAILURE_CODE_DESCRIPTIONS: Record<string, string> = {
  ...
  // Deliberately does not blame the host: the runner (the agent's process)
  // can drop while the host stays online, and the host badge then correctly
  // shows the host as connected — copy saying "the host dropped" contradicts it.
