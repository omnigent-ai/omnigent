// The onboarding card + animated blob panel + centered starfish logo.
//
...
// The background is BlobGraphic (pure-CSS floating blobs), also dependency-free.
//
  ...
  return (
    ...
    >
      <div className="omnigent-animated-panel" style={{ height: panelHeight }}>
        ...
        {bandContent != null ? (
          <div className="omnigent-panel-band-content">{bandContent}</div>
        ) : (
          <img
            src={omnigentLogo}
            alt="Omnigent"
