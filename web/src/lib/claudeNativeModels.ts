 ...
 * `databricks-claude-sonnet-4-6`). The bare `fable` alias matches via the
 * list, and pinned `claude-fable-5` sessions also pass via the `claude`
 * branch. Rejects everything else — notably the
