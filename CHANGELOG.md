...
- [Bug fix] An expired Claude Code login now tells you to run `omni setup` instead of (#4275)
...
- [Docs] Create the Slack app from a manifest instead of configuring scopes, events, and Socket (#5806)
...
- [Bug fix] Token counts now show in the UI for ACP-based harness sessions (jcode, Devin, Grok, and any (#6882)
...
- [UI] [UI] Clone dialog's Model / Effort / Permission pickers now use the same compact font as the Agent field (#6929)
...
- [UI / Bug fix] Fixed: the New Chat picker's "hide unconfigured harnesses" now correctly hides a harness (#7414)
