...
- [Test/CI] N/A — test-only; the user-facing fix shipped in #4314. (#4280)
...
- [Bug fix] The claude-sdk harness (and the ACP / qwen / kimi / goose / pi / tmux launch (#4586)
...
- [UI / Bug fix / Feature] Right-click or long-press a project folder for its actions; project emoji icons (#5740)
...
- [Bug fix] Reading a session hits the database once instead of twice, cutting a network (#6074)
...
- [UI] The onboarding "Starting Omnigent" step now streams the local server's real (#6186)
...
- [UI] "Connect to new server…" now opens the server list directly, and connection (#6189)
...
- [Bug fix] Fixed a black screen at launch when the saved server was unreachable and the (#6191)
...
- [UI / Bug fix] The GitHub panel now names each reason it has nothing to show — an outdated (#6275)
...
- [Bug fix] claude-native: large pastes (e.g. messages opening with a long URL) no longer (#6377)
...
- [UI] [UI] The header breadcrumb now shows the project's custom emoji icon instead of always a folder icon (#6407)
...
- [UI / Chore] Conversation switching in the sidebar is noticeably faster — the sidebar no (#6413)
...
- [UI / Chore] [UI] Switching conversations in the sidebar is snappier, especially with the workspace panel open (#6419)
...
- [UI] [UI] Switching between long conversations is now fast — the transcript renders only the messages on screen. (#6522)
