...
def create_runner_app(
    *,
    ...
    async def _run_turn_bg_setup_and_stream(
        ...
        raw_harness_name: str | None = None
        spawn_env: dict[str, str] | None = None
        instructions: str | None = None
        _note_session_harness_override(conv, cast(str | None, msg_body.get("harness_override")))
        if cached_spec is not None:
            # The recorded override outranks the spec and retains any ACP slug.
            raw_harness_name = (
            ...
            harness_name = canonicalize_harness(raw_harness_name) or raw_harness_name
    ...
    try:
        ...
        if harness == "claude-sdk":
            ...
            env = _build_acp_spawn_env(
                effective_spec, harness=requested_harness, cwd=cwd, workdir=workdir
            )
