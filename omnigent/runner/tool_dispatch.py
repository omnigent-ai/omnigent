...
_MEMORY_TOOLS = frozenset({"memory_retain", "memory_recall", "memory_reflect"})
...
def _memory_config_from_spec(agent_spec: Any | None, tool_name: str) -> dict[str, str]:
    """
    ...
    for the entry named *tool_name* (e.g. ``"memory_recall"``) and returns its
...
async def _execute_memory_tool(
    ...
    *,
    ...
    config = _memory_config_from_spec(agent_spec, tool_name)
