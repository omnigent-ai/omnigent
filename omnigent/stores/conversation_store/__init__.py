...
class ConversationStore(ABC):
    ...
    def set_session_state(
        ...
        Replaces the policy-visible state wholesale — last writer wins,
        including over keys the caller never read — while preserving the
        internal Plan key in the existing conversation metadata JSON. Use it
        to install a state outright (seeding, import, tests).
