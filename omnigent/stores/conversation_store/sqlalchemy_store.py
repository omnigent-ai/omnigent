...
class SqlAlchemyConversationStore(ConversationStore):
    ...
    def set_session_state(
        ...
        """
        with self._session_immediate("set_session_state") as session:
    ...
    def set_session_todos(
        ...
        with self._session_immediate("set_session_todos") as session:
            q = select(SqlConversationMetadata).where(
                SqlConversationMetadata.workspace_id == current_workspace_id(),
                SqlConversationMetadata.id == conversation_id,
            )
    ...
    def switch_conversation_agent(
        ...
        *,
        ...
        with self._session_immediate("switch_conversation_agent") as session:
