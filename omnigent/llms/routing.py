...
PROVIDER_CONFIGS: dict[str, str | None] = {
    ...
    # LiteLLM resolves the provider from the model string (SDK mode) or
    # routes through a proxy via connection_params["base_url"], so there
    # is no fixed base URL here.
    "litellm": None,
}
