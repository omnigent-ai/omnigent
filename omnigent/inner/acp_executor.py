...
class AcpExecutor(Executor):
    ...
    def __init__(
        ...
        self._self_executed_args: dict[str, _AcpJsonObject] = {}
    ...
    def _session_mcp_servers(self) -> list[_AcpJsonObject]:
        ...
        classification cannot drift apart. With Omnigent MCP disabled there are
        no entries and no aliases, so every call classifies as self-executed.
        """
    ...
    def _handle_session_update(self, update: _AcpJsonObject) -> list[ExecutorEvent]:
        ...
        if update_type == _UPDATE_AGENT_MESSAGE_CHUNK:
            ...
            if isinstance(call_id, str) and status in (
                ...
                complete_metadata: _AcpJsonObject = {"call_id": call_id}
