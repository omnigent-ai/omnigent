...
def create_sessions_router(
    ...
    from omnigent.server.routes._sessions.routes_agent import register_agent_routes
    from omnigent.server.routes._sessions.routes_browser import register_browser_routes
    from omnigent.server.routes._sessions.routes_core import register_core_routes
    from omnigent.server.routes._sessions.routes_elicitations import register_elicitations_routes
    from omnigent.server.routes._sessions.routes_events import register_events_routes
    from omnigent.server.routes._sessions.routes_hooks import register_hooks_routes
    from omnigent.server.routes._sessions.routes_items import register_items_routes
    from omnigent.server.routes._sessions.routes_permissions import register_permissions_routes
    from omnigent.server.routes._sessions.routes_resources import register_resources_routes
