...
"Hardware sizing"). The main server points
``OMNIGENT_DICTATION_REMOTE_URL`` at this worker and relays takes; the
...
The same ``OMNIGENT_DICTATION_*`` env vars configure it (model dirs,
stream cap, fake engine for tests).
