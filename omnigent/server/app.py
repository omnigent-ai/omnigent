...
def create_app(
    ...
    # Reachable from any route: the session lifecycle reads a project's stored
    # config to resolve its worktree setup / teardown commands (see
    # ``omnigent.server.worktree_hooks``).
