...
1. **Server YAML** (OSS / self-hosted): :func:`parse_sandbox_config`
   ...
   ``<data_dir>/config.yaml``)::
       ...
       sandbox:
         # lakebox|modal|daytona|blaxel|boxlite|cwsandbox|islo|e2b|opensandbox|
         # gensee|openshell|kubernetes|microsandbox
         provider: modal
   ...
   Gensee reads the environment variable named by
