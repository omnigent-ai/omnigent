...
class CompactionConfig:
    ...
    :param headroom_enable_ccr: Enable Content-Cache-Retrieval for
        reversible compression. When ``True``, original content is
        cached locally and can be retrieved via ``headroom_retrieve()``
