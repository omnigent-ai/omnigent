...
terminal prompt then race (see :mod:`omnigent.harnesses.claude_native.hook` and the
...
exactly the old behaviour. Mirrors :mod:`omnigent.harnesses.hermes_native.permissions`.
