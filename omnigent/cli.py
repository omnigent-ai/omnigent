    ...
    while True:
        ...
        if not cursor_sdk_installed():
            ...
            cursor_sub_lines.append(
                ...
                f"({_rich_escape(extra_install_display(CURSOR_EXTRA))})[/]"
            )
        cursor_sub_lines.append(
        ...
        if not antigravity_sdk_installed():
            ...
            ag_sub_lines.append(
                f"[dim]not installed — open to install "
                f"({_rich_escape(extra_install_display(ANTIGRAVITY_EXTRA))})[/]"
            )
        ag_sub_lines.append(
        ...
        if not copilot_sdk_installed():
            ...
            copilot_sub_lines.append(
                f"[dim]not installed — open to install "
                f"({_rich_escape(extra_install_display(COPILOT_EXTRA))})[/]"
            )
        copilot_sub_lines.append(
