...
def _print_opencode_auth_help() -> None:
    ...
    console.print(
        ...
        "      including OPENCODE_API_KEY for OpenCode's own Zen / Go gateway.\n"
        "    • A providers: entry with an ``opencode:`` family in ~/.omnigent/config.yaml\n"
        "      delivers an OpenCode Zen / Go key to agents that name it via executor.auth.\n"
