...
def generate_schedule_id() -> str:
    """
    Generate a unique schedule identifier.

    :returns: A string of the form ``"sch_<32-char hex>"``,
        e.g. ``"sch_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6"``.
    """
...
def generate_push_subscription_id() -> str:
    """
    Generate a unique push subscription identifier.

    :returns: A string of the form ``"push_<32-char hex>"``,
        e.g. ``"push_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6"``.
    """
    return f"push_{uuid.uuid4().hex}"


def generate_user_credential_id() -> str:
    """
    Generate a unique user-credential (vault) identifier.

    :returns: A string of the form ``"cred_<32-char hex>"``,
        e.g. ``"cred_a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6"``.
    """
