...
The flock and the pid live in one file — the record — so a future liveness
probe can read the pid and test the lock in the same open. This relies on the
record being rewritten in place (``Path.write_text``, see
