...
@pytest.mark.parametrize(
    ("wire_error_code", "launch_error", "expected_error_code", "expected_fragment"),
    [
        (
            HARNESS_NOT_CONFIGURED_ERROR_CODE,
...
async def test_launch_runner_categorical_failure_returns_412(
    host_api_app: tuple[FastAPI, HostRegistry, HostStore, SqlAlchemyConversationStore],
    ...
    to 412 with a specific code, after rolling back the runner bind.
    ...
    if expected_error_code == WORKSPACE_NOT_FOUND_ERROR_CODE:
