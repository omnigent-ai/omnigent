...
def test_overview_lists_all_harnesses_in_priority_order(isolated_config, monkeypatch) -> None:
    ...
    expected = [
        ...
        "Qwen Code",
        "Goose",
        # Builtin ACP CLI rows (ACP_CLI_HARNESSES) render after Goose and before
        # the non-ACP harnesses.
        "Grok Build",
        "Rovo Dev",
        "Copilot",
        "Kiro",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # 10 and 11 are the builtin ACP CLI rows (Grok Build and Rovo Dev);
        # every row after them shifts down accordingly.
