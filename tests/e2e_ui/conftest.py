...
def browser_context_args(
    ...
    """Return fresh Playwright context options with optional video recording.

    Sync page/context fixtures need these options in addition to the Browser
    patch. An explicit record_video_dir takes precedence over the environment."""
