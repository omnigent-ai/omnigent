...
from tests.unit.runtime.policies.conftest import make_fixed_function_policy_spec
        ...
        guardrails=GuardrailsSpec(
            ...
            policies=[
                make_fixed_function_policy_spec(
                    ...
                    fn_path="tests.unit.runtime.policies.conftest._always_allow_taint_integrity",
                ),
            ],
            ask_timeout=45,
        ),
