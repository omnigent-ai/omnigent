...
Omnigent is an open-source **meta-harness** that gives you a common orchestration layer over Claude Code, Codex, Cursor, OpenCode, Hermes, Pi, Qoder, Qoder CN, and the agents you write yourself: swap or combine harnesses without rewriting, enforce policies and sandboxing, and collaborate in real time from any device — terminal, browser, phone, or the native desktop app.
...
executor:
  harness: claude-sdk          # or: claude-native, codex, codex-native, cursor,
                               ...
                               # pi, pi-native, openai-agents, qoder, qoder-cn
