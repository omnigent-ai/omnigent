...
Omnigent is an open-source **meta-harness** that gives you a common orchestration layer over Claude Code, Codex, Cursor, OpenCode, Hermes, Pi, and the agents you write yourself: mix or combine harnesses without rewriting, enforce policies and sandboxing, and work together in real time from any device — terminal, browser, phone, or the native desktop app.
